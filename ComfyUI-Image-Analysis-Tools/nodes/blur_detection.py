...
class BlurDetection:
    ...
    def execute(self, image, block_size, visualize_blur_map):
        try:
            img_tensor = image[0]
            ...
            return (0.0, fallback, f"Error: {e}")


NODE_CLASS_MAPPINGS = {"BlurDetection": BlurDetection}
NODE_DISPLAY_NAME_MAPPINGS = {"BlurDetection": "Blur Detection"}